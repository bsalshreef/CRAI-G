...
[![Tests](https://github.com/YOUR_USERNAME/CRAI-G/actions/workflows/tests.yml/badge.svg)](https://github.com/YOUR_USERNAME/CRAI-G/actions)
...
```bash
git clone https://github.com/YOUR_USERNAME/CRAI-G.git
cd CRAI-G
